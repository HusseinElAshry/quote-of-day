...
[  
    ...
    {  
       text:"If plan A fails remember you have 25 letters left.",
       from:"unknown"
    },
    {  
    ...
    {
        text:"fuck off",
        from :"ser sandor clegane a.k.a the hound"
    }

 ];
function getWise() {
    var x = Math.floor(Math.random()*captions.length);
    var wise = captions[x].text ;
    var auther = captions[x].from;
    document.getElementById("wise").innerHTML = "&quot;" + wise + "&quot;";
